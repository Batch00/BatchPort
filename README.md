...
- **Trip hero (one photo).** The frame the trip story opens and closes on, the frame the Year in Travel recap opens on, and the photograph the share card is drawn over. Leave it alone and both fall back to the trip cover, then to your earliest photo of the trip; the panel says so and previews the picture you would get.
